				...
				_1: {
					...
					_1: {
						...
						_0: A2(_elm_lang$html$Html$button, {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$DelBook(book.id)),
							_1: { ctor: '[]' }
						}, {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(_elm_lang$html$Html$input, {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$GetTitle),
								_1: { ctor: '[]' }
							}
						}
					}
				...
				_1: {
					...
					_1: {
						...
						_0: A2(_elm_lang$html$Html$input, {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('author'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_('text'),
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$GetAuthor),
										_1: { ctor: '[]' }
									}
								}
							}
						...
						_1: {
							...
							_0: A2(_elm_lang$html$Html$label, {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$for('published'),
								_1: { ctor: '[]' }
							}, {
								ctor: '::',
							...
							_1: {
								...
								_0: A2(_elm_lang$html$Html$input, {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('published'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_('checkbox'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$GetPublished),
											_1: { ctor: '[]' }
										}
									}
								}, { ctor: '[]' }),
								_1: {
									...
									_0: A2(_elm_lang$html$Html$button, {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$PostBook),
										_1: { ctor: '[]' }
									}, {
										ctor: '::',
										_0: _elm_lang$html$Html$text('Post Book!'),
										_1: { ctor: '[]' }
									}),
									_1: { ctor: '[]' }
								}
	...
	var _user$project$Main$view = function _user$project$Main$view(model) {
		return A2(_elm_lang$html$Html$div, { ctor: '[]' }, {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$bookForm(model),
					_1: { ctor: '[]' }
				}
			}
		});
